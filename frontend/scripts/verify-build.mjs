...
for (const expected of ['TASKS', 'PLAYERS', 'V0.4.5 DEV', '个人任务', '共享任务']) {
  assert(bundle.includes(expected), `production bundle is missing ${expected}`)
}
for (const obsolete of ['TONIGHT', '今晚任务', '在线玩家', '缓存命中', '显示缓存数据', '安全边界', 'V0.4.1 DEV', 'V0.4.2 DEV', 'V0.4.3 DEV', 'V0.4.4 DEV']) {
